  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>AH Shop</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               AH Shop Head Office
               Email:AH@Shoo.com <br>
               Mob: 8923244846 <br>
               Delhi India <br>
    ...
    <tr>
        <td>
          <p class="font" style="margin-left: 20px;">
           ...
           <strong>Address:</strong> {{$orders->division->division_name}}, {{$orders->destrict->distric_name}}, {{$orders->state->state_name}}<br>
           <strong>Post Code:</strong> {{$orders->post_code}}
         </p>
        </td>
        <td>
          <p class="font">
            <h3><span style="color: green;">Invoice:</span> #{{$orders->invoice_number}}</h3>
...
<h3>Products</h3>
  ...
  <table width="100%" style=" padding:0 10px 0 10px;">
    <tr>
        <td align="right" >
            <h2><span style="color: green;">Subtotal:</span> {{$orders->amont}}</h2>
            <h2><span style="color: green;">Total:</span> {{$orders->amont}}</h2>
