...
<body class="hold-transition theme-primary bg-gradient-primary">
								...
								<div class="form-group">
								  ...
								  <div class="row">
									...
									<div class="col-12 text-center">
									  <input type="submit" name="submit" class="btn btn-info btn-rounded mt-10" value="Sign In">
									</div>
									<!-- /.col -->
								  </div>
							</form>														
	...
	<!-- Vendor JS -->
	<script src="{{asset('backend/vendors.min.js')}}"></script>
